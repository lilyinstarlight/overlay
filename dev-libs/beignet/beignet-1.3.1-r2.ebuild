...
PATCHES=(
	...
	"${FILESDIR}"/0001-Backend-Remove-old-llvm-support-code.patch
	"${FILESDIR}"/0002-Backend-Fix-an-include-file-error-problem.patch
	"${FILESDIR}"/0003-Backend-Refine-LLVM-version-check-macro.patch
	"${FILESDIR}"/0004-Backend-Add-LLVM40-support.patch
)
