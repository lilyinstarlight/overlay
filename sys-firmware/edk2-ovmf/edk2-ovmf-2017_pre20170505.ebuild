...
src_install() {
	...
	dosym edk2/ovmf /usr/share/OVMF
	dosym edk2/ovmf /usr/share/${PN}

	readme.gentoo_create_doc
}

pkg_preinst() {
	if [ -d /usr/share/${PN} ]; then
		rm -f /usr/share/${PN}/OVMF.fd
		rm -f /usr/share/${PN}/OVMF_CODE.fd
		rm -f /usr/share/${PN}/OVMF_VARS.fd
		rmdir --ignore-fail-on-non-empty /usr/share/${PN}
	fi
}
